		...
		<div className="mx-auto max-w-2xl px-4">
			<div className="rounded-lg border bg-background p-8">
				...
				<p className="leading-normal text-muted-foreground">
					Try prompting the chatbot with an in-depth question. The first time
					you ask, it will be streamed as normal. Subsequent times, it will be
					served from the cache near-instantly.
				</p>
